...
**[🌐 Сайт](https://fabianoortega-ops.github.io/jellyfin-legendaz) · [📦 Установить](#installation) · [🌍 Языки](#supported-languages) · [🐛 Проблемы](https://github.com/fabianoortega-ops/jellyfin-legendaz/issues)**
...
*Хотите добавить свой язык? [Откройте PR!](https://github.com/fabianoortega-ops/jellyfin-legendaz/pulls)*
...
Legendaz добавляет **кнопку 🔍** в OSD плеера Jellyfin. Один клик открывает панель поиска — ищите по языку, выбирайте результат, и субтитр скачивается и выбирается автоматически.
...
[MIT License](../LICENSE) · [Сайт](https://fabianoortega-ops.github.io/jellyfin-legendaz) · [Releases](https://github.com/fabianoortega-ops/jellyfin-legendaz/releases)
