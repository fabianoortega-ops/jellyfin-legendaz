...
**[🌐 Sito](https://fabianoortega-ops.github.io/jellyfin-legendaz) · [📦 Installa](#installation) · [🌍 Lingue](#supported-languages) · [🐛 Problemi](https://github.com/fabianoortega-ops/jellyfin-legendaz/issues)**
...
*Vuoi aggiungere la tua lingua? [Apri una PR!](https://github.com/fabianoortega-ops/jellyfin-legendaz/pulls)*
...
Legendaz aggiunge un **pulsante 🔍** nell'OSD del player Jellyfin. Un clic apre un pannello di ricerca — cerca per lingua, scegli un risultato e il sottotitolo viene scaricato e selezionato automaticamente.
...
[MIT License](../LICENSE) · [Sito](https://fabianoortega-ops.github.io/jellyfin-legendaz) · [Releases](https://github.com/fabianoortega-ops/jellyfin-legendaz/releases)
