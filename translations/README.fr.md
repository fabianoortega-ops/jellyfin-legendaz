...
**[🌐 Site](https://fabianoortega-ops.github.io/jellyfin-legendaz) · [📦 Installer](#installation) · [🌍 Langues](#supported-languages) · [🐛 Problèmes](https://github.com/fabianoortega-ops/jellyfin-legendaz/issues)**
...
*Vous voulez ajouter votre langue ? [Ouvrez un PR !](https://github.com/fabianoortega-ops/jellyfin-legendaz/pulls)*
...
Legendaz ajoute un **bouton 🔍** dans l'OSD du lecteur Jellyfin. Un clic ouvre un panneau de recherche — cherchez par langue, choisissez un résultat, et le sous-titre est téléchargé et sélectionné automatiquement.
