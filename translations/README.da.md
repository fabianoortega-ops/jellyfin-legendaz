...
**[🌐 Website](https://fabianoortega-ops.github.io/jellyfin-legendaz) · [📦 Installeren](#installation) · [🌍 Talen](#supported-languages) · [🐛 Problemen](https://github.com/fabianoortega-ops/jellyfin-legendaz/issues)**
...
*Wil je jouw taal toevoegen? [Open een PR!](https://github.com/fabianoortega-ops/jellyfin-legendaz/pulls)*
...
Legendaz voegt een **🔍 knop** toe in de Jellyfin-videospeler OSD. Eén klik opent een zoekpaneel — zoek op taal, kies een resultaat en de ondertitel wordt automatisch gedownload en geselecteerd.
