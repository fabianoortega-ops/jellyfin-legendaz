...
**[🌐 웹사이트](https://fabianoortega-ops.github.io/jellyfin-legendaz) · [📦 설치](#installation) · [🌍 언어](#supported-languages) · [🐛 문제](https://github.com/fabianoortega-ops/jellyfin-legendaz/issues)**
...
*언어를 추가하시겠습니까? [PR을 열어주세요!](https://github.com/fabianoortega-ops/jellyfin-legendaz/pulls)*
...
Legendaz는 Jellyfin 비디오 플레이어 OSD에 **🔍 버튼**을 추가합니다. 클릭하면 검색 패널이 열리고 언어로 검색하여 결과를 선택하면 자막이 자동으로 다운로드되고 선택됩니다.
