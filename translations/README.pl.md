...
**[🌐 Strona](https://fabianoortega-ops.github.io/jellyfin-legendaz) · [📦 Zainstaluj](#installation) · [🌍 Języki](#supported-languages) · [🐛 Problemy](https://github.com/fabianoortega-ops/jellyfin-legendaz/issues)**
...
*Chcesz dodać swój język? [Otwórz PR!](https://github.com/fabianoortega-ops/jellyfin-legendaz/pulls)*
...
Legendaz dodaje **przycisk 🔍** w OSD odtwarzacza Jellyfin. Jedno kliknięcie otwiera panel wyszukiwania — wyszukaj według języka, wybierz wynik, a napisy zostaną pobrane i automatycznie wybrane.
...
[MIT License](../LICENSE) · [Strona](https://fabianoortega-ops.github.io/jellyfin-legendaz) · [Releases](https://github.com/fabianoortega-ops/jellyfin-legendaz/releases)
